...
<script type="text/javascript">
	...
	function btnBuyOnClick() {
		if(validate('showDate','date') && validate('showTime', 'showTime') && validate('halfTicket','number')){
			$("#filmBookForms").attr("action", "/platinum.do");
			$("form")[0].submit();
		}
	}
...
<div id="ticketForm">
  	<form action="/platinum.do" method="post" id="filmBookForms" name="filmBookForms">
  		...
  		<div style="margin-left:260px">
  			<label>
	  			...
	  			<% String[] shows = (String[])request.getAttribute("platinumShows"); 
...
<div class="seatingArrangement" align="center" style="width:920px; height:870px;">
  <div style="width:920px;">
  	...
  	<div style="width:354px;height:224px;padding:8px 2px 6px 12px;">
  		<iframe width="354" height="250" src="//${requestScope['platinumShowYoutube'] }?autoplay=1&fmt=17&controls=0&iv_load_policy=3" frameborder="0" allowfullscreen></iframe>
  	</div>
  	</div>
